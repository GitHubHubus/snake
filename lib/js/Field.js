class Field {
    ...
    createPoint (departure, destination, color) {
        let params = departure || this.startPositionStrategy.getPosition({width: 0, max: {x: this._countX, y: this._countY}, x: 0, y: 0});
        ...
        params.id = ++this._counter;
        params.destination = destination || this.startPositionStrategy.getPosition({width: 0, max: {x: this._countX, y: this._countY}, x: 0, y: 0});
