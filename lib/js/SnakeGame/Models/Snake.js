...
class Snake {
    constructor (params) {
        ...
        if (params.user) {
            ...
            this._moveStrategy = new SearchNearest();
    ...
    _handleEnemy(event) {
        ...
        let point = {destination: event.p, x: this._snake[0].x, y: this._snake[0].y}
        
        this._direction = this._moveStrategy.searchNearest(point)[0].d;
    }
